...
- `value`:
  ...
  the mean temperature anomaly as deviation from corresponding 1951-1980
  mean
...
water temperature anomalies. Of note: the day value in the `date` column
has no real value. It was just a way of combining data that are
