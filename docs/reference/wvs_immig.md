...
limits". 4 = "Prohibit people from coming" for the `e143` variable. See
[`?wvs_ccodes`](http://svmiller.com/reference/wvs_ccodes.md) for more
information about naming/identifying countries.
