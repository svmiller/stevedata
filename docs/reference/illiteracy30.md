...
- `fpwhite`:
  ...
  a numeric vector for the total white population with "foreign or mixed
  parentage"

- `fpwhite_il`:

  a numeric vector for the total white population with "foreign or mixed
  parentage" that is illiterate
...
methodological corrections." *International Journal of Epidemiology*
40(4): 1123-25.
