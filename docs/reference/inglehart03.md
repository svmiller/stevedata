...
- `muslim`:
  ...
  a dummy variable that equals 1 if Inglehart codes the state as being a
  "predominantly Islamic society"

## Details

Data manually entered based on Table 1 and Table 2 in Inglehart's (2003)
article.

## References

Inglehart, Ronald. 2003. "How Solid is Mass Support for Democracy—And
How Can We Measure It?" *PS: Political Science & Politics* 36(1): 51–57.
