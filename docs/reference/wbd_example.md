...
- `lifeexp`:
  ...
  the average life expectancy at birth for men and women for the country
  that year
...
package. The underlying data come from the World Bank national accounts
(GDP per capita), World Bank analyst estimates (human capital index), or
the United Nations Population Division (life expectancy at birth).
