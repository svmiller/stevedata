...
- `educat`:
  ...
  holders). 6 = BA-level degree. 7 = advanced degree, including Bachelor
  of Laws degrees.

- `urbanism`:

  1 = central cities. 2 = suburban areas. 3 = rural/small towns/outlying
  areas.
...
- `govt_biginterests`:
  ...
  big interests. 0 = Run for the benefit of all people. 1 = Run by a few
  big interests.
