...
converting the quantity to a probability (by way of
[`pnorm()`](https://rdrr.io/r/stats/Normal.html)) communicates a
probability that the observation in question is a 1 (i.e. a democracy).
Try it out with some of the highest and lowest observations to see this
in practice.
