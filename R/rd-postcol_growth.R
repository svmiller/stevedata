...
#'
#' A simple data set on post-colonial growth trajectories in the African continent,
...
#' identifying the state from which the state identified in the \code{ccode}
#' gained independence}
...
#' \item{\code{mrgdppc5}}{an estimate of GDP per capita 5 years from the year
#' identified in the \code{styear} column}
#' \item{\code{mrgdppc10}}{an estimate of GDP per capita 10 years from the year
#' identified in the \code{styear} column}
#' \item{\code{mrgdppc15}}{an estimate of GDP per capita 15 years from the year
#' identified in the \code{styear} column}
#' \item{\code{mrgdppc20}}{an estimate of GDP per capita 20 years from the year
#' identified in the \code{styear} column}
#' \item{\code{mrgdppc25}}{an estimate of GDP per capita 25 years from the year
#' identified in the \code{styear} column}
#' }
#'
#' @details
#'
#' Data are generated with assistance from \pkg{isard}, another R package I
#' maintain.
#'
#' Data are sliced to record only latest system entry into the CoW data, which
#' concerns states (like Morocco, Tunisia, and Ethiopia) that were temporarily
#' occupied and eliminated.
#'
#' I take some liberties classifying former colonial masters in the \code{colmast}
...
#'
#' Bolt, Jutta and Dirk Bezemer. 2009. "Understanding Long-Run African Growth:
#' Colonial Institutions or Colonial Education?" *The Journal of Development
#' Studies* 45(1): 24--54.
#'
#' Gallup, John Luke, Jeffrey D. Sachs, and Andrew D. Mellinger. 1999. "Geography
#' and Economic Development." *International Regional Science Review* 22(2):
#' 179--232.
#'
