...
#' This is a data set of interest to replicating Western and Jackman (1994), who themselves
#' were addressing a debate between Wallerstein and Stephens on which of two highly correlated
#' predictors (\code{size}, \code{concen}) explains trade union density (\code{union}).
#'
...
#' \item{\code{union}}{a numeric vector for the percentage of the total number of
...
#' \item{\code{left}}{a numeric vector tapping the extent to which parties of
#' the left have controlled governments since 1919, due to Wilensky (1981).}
#' \item{\code{size}}{a numeric vector measuring the log of labor force size,
#' defined as the number of wage and salary earners, plus the unemployed.}
#' \item{\code{concen}}{a numeric vector measuring the percentage of employment,
...
#' }
#'
#' @details Data documentation are derived from Simon Jackman's \code{pscl} package.
#' I just tidied up the presentation a bit.
#'
#' @references Jackman, Simon. 2009. Bayesian Analysis for the Social Sciences. Wiley: Hoboken, New Jersey.
#'
#' @source Pryor, Frederic. 1973. Property and Industrial Organization in Communist and Capitalist Countries. Bloomington: Indiana University Press.
#'
