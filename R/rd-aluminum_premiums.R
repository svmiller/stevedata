...
#' \item{\code{group}}{a factor with levels of \code{East Asia}, \code{Southeast Asia},
#' \code{United States}, and \code{Western Europe}}
#' \item{\code{price}}{a numeric vector for the price of the LME aluminum premium}
#' }
#'
#' @details LME aluminum premiums (monthly contracts going out to 15 months) work
