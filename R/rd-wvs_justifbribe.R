...
#'  measurements.
#'
#' @format A data frame with 348,532 observations on the following 6 variables.
#' \describe{
...
#' \item{\code{e143}}{an attitude about the justifiability of bribe-taking in the World Values Survey}
#' }
#'
