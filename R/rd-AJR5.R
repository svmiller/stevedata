...
#' \item{\code{muslim80}}{the percentage of the country that is esimated to be Muslim}
#'  \item{\code{lat_abst}}{the latitude of the country (aboslute value)}
...
#' \item{\code{f_french}}{a dummy variable indicating whether the observation is in the 'base sample'}
#' }
#'
#' @details
#'
