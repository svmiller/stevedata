...
#' \item{\code{time}}{the particular time period of observation}
#' \item{\code{price}}{a numeric vector for the price of turnips, in bells}
#' }
#'
#' @details Sunday prices are set for purchase and do not fluctuate. Tommy and Timmy do not accept turnips on Sunday either. Daily prices
#' fluctuate both at opening on Nook's Cranny and after noon. This amounts to three time periods in the data. "5:00 a.m." is reserved only for
