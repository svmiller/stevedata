...
#' \item{\code{pop}}{the population size of the respondent's community}
...
#' \item{\code{educ}}{a character vector indicating whether the respondent has a primary (P), secondary (S), or post-secondary (PS) education}
...
#' for the status quo.
#'
#' You may find it in your interest to relabel the "region" variable. In these
